...
let parsedValue = parseInt(enternumber);

if(isNaN(parsedValue) || parsedValue <=0){
    throw { message: 'invalid input brother'};
}
...
try {
    ...
    console.log('error');
    // chosenMaxLife = 100;
    // alert('u entered wrong , default value 100 is used');
    throw error;
}
...
for(const logentry of battleLog){
    ...
    if( (!lastEntry && lastEntry !== 0) || lastEntry < i)   {
        console.log(`#${i}`);
